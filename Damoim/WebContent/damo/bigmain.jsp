  ...
  <div class="py-5" style="">
    ...
    <div class="row">
      ...
      <div class="row">
        ...
        <div class="col-md-1"><a href="./login.jsp">로그인</a></div>
        <div class="col-md-1"><a href="./reg1.jsp">회원가입</a></div>
      </div>
       <div class="row">
      ...
      <div class="row">
        ...
        <div class="col-md-2"></div>
            ...
            <li class="nav-item"> <a href="./bigmain.jsp" class="active nav-link">홈</a> </li>
